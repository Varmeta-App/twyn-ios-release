...
Pod::Spec.new do |s|
  s.name             = 'TwynCommon'
  s.version          = '1.0.1'
  s.summary          = 'The shared typed event vocabulary of Twyn.'
  s.description      = <<-DESC
TwynBase: the typed event functions every vertical shares -- screens, sign-in,
the IAP funnel, ad delivery. Generated from the Android pack of the same name, so
one call site means one thing on both platforms.
  DESC
  ...
  s.vendored_frameworks = 'TwynCommon/TwynCommon.xcframework'
