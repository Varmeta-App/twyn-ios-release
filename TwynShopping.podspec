...
Pod::Spec.new do |s|
  s.name             = 'TwynShopping'
  s.version          = '1.0.0'
  s.summary          = 'Twyn typed events for commerce apps.'
  s.description      = <<-DESC
Typed event functions for commerce: catalogue, cart, checkout, orders, coupons,
loyalty. Generated from the Android pack of the same name.
  DESC
  ...
  s.vendored_frameworks = 'TwynShopping/TwynShopping.xcframework'
