...
Pod::Spec.new do |s|
  s.name             = 'TwynContent'
  s.version          = '1.0.0'
  s.summary          = 'Twyn typed events for content and media apps.'
  s.description      = <<-DESC
Typed event functions for content and media: playback, paywalls, subscriptions,
creators, rewarded video. Generated from the Android pack of the same name.
  DESC
  ...
  s.vendored_frameworks = 'TwynContent/TwynContent.xcframework'
